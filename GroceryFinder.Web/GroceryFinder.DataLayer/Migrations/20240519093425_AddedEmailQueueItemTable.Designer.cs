...
namespace GroceryFinder.DataLayer.Migrations
{
    ...
    [Migration("20240519093425_AddedEmailQueueItemTable")]
    partial class AddedEmailQueueItemTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GroceryFinder.DataLayer.Models.EmailQueueItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");

                    b.Property<string>("EmailInfoJson")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("GroceryFinder.DataLayer.Models.PriceUpdateSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("PriceUpdateSubscription");
                });
            ...
            modelBuilder.Entity("GroceryFinder.DataLayer.Models.PriceUpdateSubscription", b =>
                {
                    b.HasOne("GroceryFinder.DataLayer.Models.AppUser", "AppUser")
                        .WithMany("PriceUpdateSubscriptions")
            ...
            modelBuilder.Entity("GroceryFinder.DataLayer.Models.AppUser", b =>
                {
                    ...
                    b.Navigation("PriceUpdateSubscriptions");
                });
